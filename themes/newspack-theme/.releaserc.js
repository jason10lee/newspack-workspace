...
module.exports = {
	...
	prepare: [
		...
		...gitCommitStep( [
			...
			'CHANGELOG.md',
			// The base theme's translation files, regenerated by release.yml just
			// before multi-semantic-release runs (see config/release.js). Only the
			// base theme ships translations; the style variations are cosmetic
			// child themes with no languages/ of their own.
			'newspack-theme/languages/**',
		] ),
	],
	plugins: [
