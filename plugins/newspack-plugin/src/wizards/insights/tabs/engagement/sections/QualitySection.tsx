...
const QualitySection = ( { current, previous }: SectionProps ) => (
	<section className="newspack-insights__section" aria-labelledby="newspack-insights-engagement-quality">
		...
		<p className="newspack-insights__section-caption">
			{ __( 'How deeply readers engage across all your content in this timeframe.', 'newspack-plugin' ) }
		</p>
		<div className="newspack-insights__metric-grid">
			<Scorecard
				label={ __( 'Avg Pages per Session', 'newspack-plugin' ) }
				description={ __( 'Pages a typical session views', 'newspack-plugin' ) }
			...
			<Scorecard
				...
				description={ __( 'Active time in a typical session', 'newspack-plugin' ) }
			...
			<Scorecard
				...
				description={ __( "% of sessions that weren't engaged", 'newspack-plugin' ) }
