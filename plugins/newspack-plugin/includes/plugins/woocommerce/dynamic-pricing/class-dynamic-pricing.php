...
use Newspack\Dynamic_Pricing\Admin\Pricing_Rule_Edit_UI;
...
final class Dynamic_Pricing {
	...
	public static function init(): void {
		...
		add_action( 'save_post_' . self::CPT, [ CPT_Pricing_Rule_Repository::class, 'flush_cache' ] );
